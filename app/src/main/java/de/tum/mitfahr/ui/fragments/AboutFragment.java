...
/**
 * Created by abhijith on 17/10/14.
 */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        switch (mNum) {
            ...
            case 3:
                ...
                break;
            case 4:
                mBackgroundView.setBackgroundResource(R.drawable.about4);
                mImageView.setImageResource(R.drawable.about_passenger);
                mHeadingView.setText(R.string.about_heading4);
                mDescriptionView.setText(R.string.about_description4);
                break;
        }
        return rootView;
    }
